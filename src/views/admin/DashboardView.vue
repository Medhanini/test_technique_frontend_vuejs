      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div
            ...
            "
          >
            <h6 class="m-0 font-weight-bold text-primary">Lines Overview</h6>
            <div class="dropdown no-arrow">
              <a
                class="dropdown-toggle"
                href="#"
...
export default {
  ...
  components:{
      ...
      TheChartDoughnut:() => import('./components/TheChartDoughnut.vue'),
      TheChartLine:() => import('./components/TheChartLine.vue'),
    },
};
</script>
